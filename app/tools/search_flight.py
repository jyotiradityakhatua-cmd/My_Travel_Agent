...
async def search_flight(source: str, destination: str, departure_date: str,
                        return_date: str = "", budget: str = "") -> str:
    """Async: call Groq to generate realistic flight options. Returns raw text."""
